...
import { UserPreferences, ProjectSuggestion, ProjectRoadmap } from './types.ts';
import { suggestProjects, generateRoadmap } from './services/geminiService.ts';
...
export default function App() {
  ...
  const handleFormSubmit = async (prefs: UserPreferences) => {
    ...
    try {
      ...
      setError("AI core busy. Please check your API key in Netlify settings.");
    } finally {
      setLoading(false);
    }
  };
